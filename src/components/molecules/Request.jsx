    ...
    return(
        <>
            ...
            <div className="md:w-[54.125rem]">
                <h1 className="md:text-[3rem] text-[1.25rem] text-[#121214] font-[700]">
                This is Perfect Time to Own a Geely Emgrand ec7
                </h1>
            </div>
            <div className="bg-request-section md:h-[32.5625rem] h-[10.75rem] w-full mt-[2.62rem] text-[#FFF] flex items-center justify-center bg-cover bg-center" >
