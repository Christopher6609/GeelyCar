            ...
            <div>
              ...
              <div className="text-center md:space-x-[3.87rem] md:py-[6.19rem] space-x-[1.63rem] py-[2.31rem]">
                <button
                  ...
                  className={`uppercase md:text-[2.25rem] text-[1.125rem] font-[700] font-[euclid] text-[#8A8A8A] ${
                    active == "interior" ? "underline text-[#000] " : null
                  }`}
                >
                  interior
                </button>
                <button
                  ...
                  className={`uppercase md:text-[2.25rem] text-[1.125rem] font-[700] font-[euclid] text-[#8A8A8A]  ${
                    active == "exterior" ? "underline text-[#000]" : null
                  }`}
                >
                  exterior
                </button>
